...
export default class RecipeScreen extends React.Component {
  ...
  SearchFilterFunction(text) {
    ...
    const newData = this.state.allRecipes.filter((item)=> {
      ...
      const itemData = item.ingredients ? item.ingredients : '';
      const textData = text;
...
/>
      ...
      <TouchableOpacity
onPress={this.props.navigation.navigate('Recipe2')}
>
<Text>switch</Text></TouchableOpacity>  

          <View styles ={{height:60,width:'50%',backgroundColor:'blue'}}>
              <SearchBar
style={{}}
